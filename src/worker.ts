...
export default {
  async fetch(request: Request): Promise<Response> {
    ...
    const pageAccessToken = url.searchParams.get('FACEBOOK_PAGE_ACCESS_TOKEN') || '';
    const pageId = url.searchParams.get('FACEBOOK_PAGE_ID') || undefined;
    const config = pageAccessToken ? { pageAccessToken, pageId } : undefined;
